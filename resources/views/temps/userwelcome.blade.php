        ...
        <div class="relative w-full max-w-2xl mx-auto">
            <div
                ...
                <div class="flex justify-center mb-6">
                    <div class="relative">
                        <div
                            class="absolute inset-0 bg-linear-to-r from-green-500 to-emerald-500 rounded-full blur-2xl opacity-20 animate-pulse">
                        </div>
                        <div
                            class="relative w-20 h-20 sm:w-24 sm:h-24 bg-linear-to-br from-green-500 to-emerald-600 rounded-full flex items-center justify-center shadow-lg shadow-green-500/30">
                ...
                <div class="text-center mb-8">
                    <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-3">
                        Welcome to <span
                            class="bg-linear-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">DailyAssist</span>
                    </h1>
                    <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-3">
                        <span
                            class="bg-linear-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">{{ $name }}</span>
                    </h1>
                    <p class="text-sm sm:text-base lg:text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                        Your account has been successfully created! You're now ready to start managing your tasks,
                        collaborating with your team, and boosting your productivity.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div class="text-center p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50">
                        <div
                            class="w-8 h-8 sm:w-10 sm:h-10 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-2">
                    ...
                    <div class="text-center p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50">
                        <div
                            class="w-8 h-8 sm:w-10 sm:h-10 bg-indigo-100 dark:bg-indigo-900/30 rounded-full flex items-center justify-center mx-auto mb-2">
                    ...
                    <div class="text-center p-3 rounded-xl bg-gray-50 dark:bg-gray-700/50">
                        <div
                            class="w-8 h-8 sm:w-10 sm:h-10 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center mx-auto mb-2">
