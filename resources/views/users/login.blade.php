            ...
            <div
                ...
                <div class="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                    <button
                        ...
                        <span class="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 truncate">Continue with
                            Google</span>
                    </button>
                ...
                <form class="space-y-3 sm:space-y-4" method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <a href="#"
                                class="text-xs sm:text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 hover:underline transition-colors">
                                Forgot password?
                            </a>
                        </div>
                        <div class="relative">
