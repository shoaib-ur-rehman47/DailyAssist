...
<nav
    class="px-4 sm:px-8 lg:px-16 py-4 bg-white/80 backdrop-blur-md dark:bg-gray-900/80 dark:backdrop-blur-md border-b border-gray-200/80 dark:border-gray-700/80 sticky top-0 z-50 transition-all duration-300">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        <!-- Logo -->
        <div class="flex items-center gap-2 group">
            <a href="{{ route('welcome') }}"
                class="flex items-center gap-2.5 transition-all duration-300 hover:opacity-80">
                <div class="relative">
                    <div
                        class="absolute inset-0 bg-blue-500/20 rounded-full blur-xl group-hover:blur-2xl transition-all duration-500">
                    </div>
                ...
                <span
                    class="font-bold text-2xl bg-linear-to-r from-blue-600 to-blue-800 dark:from-blue-400 dark:to-blue-300 bg-clip-text text-transparent tracking-tight">
                    DailyAssist
                </span>
            </a>
        </div>
            ...
            @foreach ($path as $key => $value)
                <li>
                    <a href="{{ route($key) }}"
                        ...
                        <span
                            class="absolute inset-0 bg-blue-50 dark:bg-blue-900/20 rounded-lg scale-0 group-hover:scale-100 transition-transform duration-300 origin-center"></span>
                        <span
                            class="absolute bottom-0 left-1/2 w-0 h-0.5 bg-blue-600 dark:bg-blue-400 group-hover:w-1/2 group-hover:left-1/4 transition-all duration-300"></span>
                        <span
                            class="absolute bottom-0 right-1/2 w-0 h-0.5 bg-blue-600 dark:bg-blue-400 group-hover:w-1/2 group-hover:right-1/4 transition-all duration-300"></span>
                    </a>
                </li>
            @endforeach
        </ul>
        ...
        <div class="flex items-center gap-3">
            ...
            <button onclick="window.location.href='{{ route('getstarted') }}'"
                ...
                <span
                    class="absolute inset-0 bg-linear-to-r from-blue-500 to-blue-600 dark:from-blue-400 dark:to-blue-500 translate-y-full group-hover:translate-y-0 transition-transform duration-300"></span>
            </button>

            <!-- Mobile Menu Button -->
            <button
                class="md:hidden p-2 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
    ...
    <div class="md:hidden hidden mt-4 pt-4 border-t border-gray-200/80 dark:border-gray-700/80" id="mobileMenu">
        <ul class="flex flex-col space-y-1">
            ...
            <li>
                <button onclick="window.location.href='{{ route('getstarted') }}'"
                    class="relative overflow-hidden group w-full px-4 py-3 bg-linear-to-r from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 text-white text-sm font-medium rounded-lg shadow-lg shadow-blue-600/25 hover:shadow-blue-600/40 transition-all duration-300">
